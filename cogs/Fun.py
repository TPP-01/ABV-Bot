...
class Fun(commands.Cog):
    ...
    async def lapogusamogusall(self, ctx):
        for channel in ctx.guild.channels:
            await self.bot.send(channel, f"{ctx.author.mention} is now a lapogusamogus")
            await self.bot.send(channel, "https://tenor.com/view/19dollar-fortnite-card-among-us-amogus-sus-red-among-sus-gif-20549014")
        await ctx.delete()

...
#cogs to use
initial_extensions = ["cogs.MainModule", "cogs.Fun", "cogs.NSFW", "cogs.BotOwner", "cogs.Admin", "cogs.Utility", "cogs.ReactionRole", "cogs.translation", "cogs.sound", "cogs.slashtest", "cogs.minecraft", "cogs.memes", "cogs.twitch"]
